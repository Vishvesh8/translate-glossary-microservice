...
def run_tests(url):
    ...
    # url = 'https://staging.vivatranslate.io/translate'
...
# url = 'http://viva-btcvden.us-east-1.elasticbeanstalk.com/glossary/remote-work/'
# run_tests(url)

url = 'https://staging.vivatranslate.io/glossary/remote-work/'
run_tests(url)
